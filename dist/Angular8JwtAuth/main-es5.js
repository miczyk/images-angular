...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppMyImagesMyImagesComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppNewImageNewImageComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcApp_servicesChangeEmailServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ChangeEmailService", function () {
    ...
    function () {
      function ChangeEmailService(http) {
        _classCallCheck(this, ChangeEmailService);

        this.http = http;
      }

      _createClass(ChangeEmailService, [{
        key: "changeEmail",
        value: function changeEmail(oldEmail, newEmail) {
          var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('newEmail', newEmail);
    ...
    ChangeEmailService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    ChangeEmailService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], ChangeEmailService);
    /***/
  },
  ...
  /***/
  function srcApp_servicesImagesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(ImagesService, [{
        key: "getImages",
        value: function getImages(pageNumber, sortingType) {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _my_images_my_images_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./my-images/my-images.component */
    "./src/app/my-images/my-images.component.ts");
    /* harmony import */


    var _new_image_new_image_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./new-image/new-image.component */
    ...
    var routes = [{
      ...
      path: 'my-images',
      component: _my_images_my_images_component__WEBPACK_IMPORTED_MODULE_8__["MyImagesComponent"]
    }, {
      path: 'add-image',
      component: _new_image_new_image_component__WEBPACK_IMPORTED_MODULE_9__["NewImageComponent"]
    }, {
      path: '',
      redirectTo: 'home',
      pathMatch: 'full'
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _helpers_auth_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./_helpers/auth.interceptor */
    "./src/app/_helpers/auth.interceptor.ts");
    /* harmony import */


    var _my_images_my_images_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./my-images/my-images.component */
    "./src/app/my-images/my-images.component.ts");
    /* harmony import */


    var _new_image_new_image_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./new-image/new-image.component */
    "./src/app/new-image/new-image.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_8__["RegisterComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_9__["HomeComponent"], _board_user_board_user_component__WEBPACK_IMPORTED_MODULE_10__["BoardUserComponent"], _profile_profile_component__WEBPACK_IMPORTED_MODULE_11__["ProfileComponent"], _my_images_my_images_component__WEBPACK_IMPORTED_MODULE_13__["MyImagesComponent"], _new_image_new_image_component__WEBPACK_IMPORTED_MODULE_14__["NewImageComponent"]],
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.authService.login(this.form).subscribe(function (data) {
            ...
            _this3.pictures = _this3.tokenStorage.getUser().pictures;
  ...
  /***/
  function srcAppMyImagesMyImagesComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppMyImagesMyImagesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MyImagesComponent", function () {
      return MyImagesComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "SortingType", function () {
      return SortingType;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function MyImagesComponent(imageServ, http) {
        _classCallCheck(this, MyImagesComponent);
      ...
      _createClass(MyImagesComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this4 = this;

          this.sortingType = SortingType.BY_NAME_ASC;
          this.imageServ.getImages(1, this.sortingType).subscribe(function (response) {
            _this4.images = response.images;
            _this4.numberOfImages = response.countOfAllImages;
            _this4.pageNumber = 1;
          });
        }
      }, {
        ...
        value: function removeImage(image) {
          ...
          this.http.delete("http://localhost:8080/images/" + image.id).subscribe(function (result) {
            console.log(result);

            _this5.imageServ.getImages(_this5.pageNumber, _this5.sortingType).subscribe(function (response) {
              _this5.images = response.images;
              _this5.numberOfImages = response.countOfAllImages;
            });
          }, function (err) {
            console.error(err);
          });
        ...
        key: "sortBy",
        value: function sortBy(sortingType) {
          var _this6 = this;

          this.sortingType = sortingType;
          this.imageServ.getImages(this.pageNumber, this.sortingType).subscribe(function (response) {
            _this6.images = response.images;
            _this6.numberOfImages = response.countOfAllImages;
          });
        }
      }, {
        key: "goToNext",
        value: function goToNext() {
          var last = Math.ceil(this.numberOfImages / 8);
        ...
        key: "getImagesWhenPageNumberIsChanged",
        value: function getImagesWhenPageNumberIsChanged() {
          var _this7 = this;

          this.imageServ.getImages(this.pageNumber, this.sortingType).subscribe(function (response) {
            _this7.images = response.images;
            _this7.numberOfImages = response.countOfAllImages;
          });
        }
      }]);
    ...
    MyImagesComponent.ctorParameters = function () {
      return [{
    ...
    MyImagesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-my-images',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./my-images.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/my-images/my-images.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./my-images.component.css */
      "./src/app/my-images/my-images.component.css")).default]
    })], MyImagesComponent);
    var SortingType;
  ...
  /***/
  function srcAppNewImageNewImageComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppNewImageNewImageComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NewImageComponent", function () {
    ...
    var NewImageComponent =
    /*#__PURE__*/
    function () {
      function NewImageComponent(http) {
        _classCallCheck(this, NewImageComponent);
      ...
      _createClass(NewImageComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "onFileSelected",
        ...
        value: function onUpload() {
          ...
          this.http.post('http://localhost:8080/images', fd).subscribe(function (res) {
            _this8.msg = res['message'];
            console.log(res);
            _this8.addedImage = true;
          }, function (err) {
            _this8.msg = err.error.message;
            _this8.addedImage = false;
          });
        }
      }]);
    ...
    NewImageComponent.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    NewImageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-new-image',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./new-image.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/new-image/new-image.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./new-image.component.css */
      "./src/app/new-image/new-image.component.css")).default]
    })], NewImageComponent);
    /***/
  },
  ...
  function srcAppProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_change_email_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../_services/change-email.service */
    "./src/app/_services/change-email.service.ts");

    var ProfileComponent =
    /*#__PURE__*/
    function () {
      function ProfileComponent(token, srvChangeEmail) {
      ...
      _createClass(ProfileComponent, [{
        ...
        key: "changeEmail",
        value: function changeEmail(input) {
          var _this9 = this;
          ...
          this.srvChangeEmail.changeEmail(this.currentUser.email, value).subscribe(function (data) {
            _this9.error = false;
            _this9.currentUser.email = value;
            _this9.msg = data['message'];
          }, function (err) {
            _this9.error = true;
            _this9.msg = err.error.message;
          });
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/michal/Dokumenty/images-angular/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
